...
*  Author Nusky M.A.M
* */
class AboutUsContactUs extends Component {
    ...
    render() {
        return (<div>
                ...
                <div className="main-content">
                    <div className={'box'}>
                        <label  className={'custom-underline'}>Energize, Enlighten, Empower</label>
                    </div>
                    <h3>About US</h3>
                    ...
                    <div className="panel-wrapper">
                        ...
                        <div className="panel-body">
                            R.I.T ALLES - FOUNDER OF GATEWAY GROUP<br></br>
                            ...
                            Being a teacher of Royal College, Colombo, then, the Founder Principal of D.S.Senanayake College, Colombo, and finally the State Secretary of Education overlooking all schools in the island, late Mr. Alles brought in a wealth of experience to this establishment.
                            Further, his initial training in Cambridge and the subsequent exposure by way of a scholarship awarded by the International Development Research Centre in Ottawa to study school systems in more than
                            ten developed countries helped him to lay the foundation to a truly international organisation.
                        </div>
                    </div>
                    <div className="panel-wrapper">
                        <div className="panel-head">
                        ...
                        <div className="panel-body">
                            DR. HARSHA ALLES – CHAIRMAN, GATEWAY GROUP<br></br>
                            Dr Harsha Alles is a Medical Doctor by profession and holds an M.B., B.S., and a Ph.D. He was a Lecturer in the Medical Faculty of the University of Colombo before he shifted his career to be in charge of Gateway. He is credited with placing the Gateway brand on the map
                            as a provider of technology-based, high-quality education through a large network of institutions that include 5 International Schools,
                            2 National Curriculum Schools, a Graduate School, and over 12 training centres spread across the country. Some of Gateway’s educational programmes have been used in twelve countries in three continents. Gateway also has a group of Kindergartens in the UK.
                    ...
                    <div className="panel-wrapper">
                        ...
                        <div className="panel-body">
                            ...
                            Consultant to the Gateway Group of Schools<br></br>
                    ...
                    <div className="panel-wrapper">
                        ...
                        <div className="panel-body">
                            Mrs. Vinita Shenoy-
                            Principal Gateway College Rajagiriya<br></br>
                    ...
                    <div className="panel-wrapperabout" >
                        <div className="panel-headabout" >
                            Contact US
                        </div></div>
                    <div className="panel-body">
                        <h4>Gateway College Colombo</h4>
                        185, Koswatta Road,<br/>
                        (Via Parliment Road, Off Royal Gardens),<br/>
                        Rajagiriya,<br/>
                        Sri Lanka.<br/><br/>

                        Telephone: 94 11 2888288,94 11 2888280<br/>
                        Fax: 94 11 2888282<br/>
                        Email: gis@gatewayworldwide.com
                    </div>
                    <hr></hr>

                    <div className="panel-body">
                        <h4>Gateway College Kandy</h4>
                        80, Wariyapola Sri Sumangala Mawatha,<br/>
                        Asgiriya,<br/>
                        Kandy<br/><br/>

                        Telephone:94 81 2200300, 94 81 2200206<br/>
                        Fax: 94 81 2205604<br/>
                        Email:gkis@gatewayworldwide.com<br/>
                    </div>

                    <hr></hr>

                    <div className="panel-body">
                        <h4>Gateway College Negombo</h4>
                        No 62,<br/>
                        Negombo Road<br/>
                        Kurana<br/><br/>

                        Telephone: 94 31 2227772,94 31 2227722<br/>
                        Fax: 031-2227878<br/>
                        Email: gnis@gatewayworldwide.com<br/>
                    </div>

                    <hr></hr>

                    <div className="panel-body">
                        <h4>Gateway College Dehiwala</h4>
                        285/1 Galwihara Road,<br/>
                        Dehiwala.<br/><br/>

                        Telephone:94 11 5757234<br/>
                        Fax:041-2227878<br/>
                        Email:gdis@gatewayworldwide.com<br/>
                    </div>

                    <hr></hr>

                    <div className="panel-body">
                        <h4>Gateway College Ratmalana</h4>
                        No 4,<br/>
                        Telawela Road,<br/>
                        Ratmalana<br/><br/>

                        Telephone: 94 11 2610061,94 11 2625394<br/>
                        Fax:081-2227878 -<br/>
