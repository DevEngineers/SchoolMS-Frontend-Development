          ...
          <form>
            <div id={"form-style-classDetails"}>
              ...
              <div id={"classSelectOpt"}>
                ...
                >
                  <MenuItem value={""}>
                    <span className={"selectCName"}>Select Class</span>
                  </MenuItem>
                ...
                >
                  <MenuItem value={""}>
                    <span className={"selectCName"}>Select Class Type</span>
                  </MenuItem>
                ...
                >
                  <MenuItem value={""}>
                    <span className={"selectCName"}>Select Year</span>
                  </MenuItem>
            ...
            <div className={"btnDiv"}>
              <input
                ...
                onClick={this.generateClassTimetable.bind(this)}
              />
              <input
                type={"reset"}
                id={"restBtn"}
