...
class UpdateClassTimetable extends React.Component {
  ...
  cancelUpdate() {
    this.props.history.push("/manageClassTimetable");
  }
  ...
  updateClassTimetable(event) {
    ...
    if (classTimetable.class === "") {
      ...
      ClassTimetableService.updateClassTimetable(
          ...
          <form>
            <div id={"form-style-classDetails"}>
              ...
              <div id={"classSelectOpt"}>
                <Select
                  ...
                  displayEmpty
                >
                  <MenuItem value={this.state.sClass}>
                    <span className={"selectCName"}>
                      {this.state.sClass.class}
                    </span>
                  </MenuItem>
                </Select>
                <Select
                  labelId="demo-simple-select-label"
                  id="demo-simple-select"
                  value={this.state.sClassType}
                  name={"sClassType"}
                  className={"classSize"}
                  onChange={(event) => this.onChange(event)}
                  displayEmpty
                >
                  <MenuItem value={this.state.sClassType}>
                    <span className={"selectCName"}>
                      {this.state.sClassType.name}
                    </span>
                  </MenuItem>
                </Select>
                <Select
                ...
                >
                  <MenuItem value={this.state.year}>
                    <span className={"selectCName"}>{this.state.year}</span>
                  </MenuItem>
                </Select>
              </div>
            </div>
              ...
              {this.state.checkedTimeSlot === false ? (
                <div className={"timeslotIcon"}>
                  <IconButton
                    aria-label="add"
                    style={{ backgroundColor: "transparent" }}
                    onClick={this.addClickOnSlot.bind(this)}
                  >
                  ...
                  <div key={i}>
                    {el === "interval" ? (
                      ...
                      <Select
                        ...
                        className={"daySize"}
                      >
                        <MenuItem value={this.state.monday[i]}>
                          <span className={"selectCName"}>
                            {this.state.monday[i]}
                          </span>
                        </MenuItem>
                        {this.state.subjects.map((subject) =>
                          this.state.monday[i] === subject.subject ? null : (
                  ...
                  <div key={i}>
                    {el === "interval" ? (
                      ...
                      <Select
                        ...
                        className={"daySize"}
                      >
                        <MenuItem value={this.state.tuesday[i]}>
                          <span className={"selectCName"}>
                            {this.state.tuesday[i]}
                          </span>
                        </MenuItem>
                        {this.state.subjects.map((subject) =>
                          this.state.tuesday[i] === subject.subject ? null : (
                            <MenuItem key={subject} value={subject.subject}>
                              <span className={"selectCName"}>
                                {subject.subject}
                              </span>
                  ...
                  <div key={i}>
                    {el === "interval" ? (
                      ...
                      <Select
                        ...
                        className={"daySize"}
                      >
                        <MenuItem value={this.state.wednesday[i]}>
                          <span className={"selectCName"}>
                            {this.state.wednesday[i]}
                          </span>
                        </MenuItem>
                        {this.state.subjects.map((subject) =>
                          this.state.wednesday[i] === subject.subject ? null : (
                            <MenuItem key={subject} value={subject.subject}>
                              <span className={"selectCName"}>
                                {subject.subject}
                              </span>
                  ...
                  <div key={i}>
                    {el === "interval" ? (
                      ...
                      <Select
                        ...
                        className={"daySize"}
                      >
                        <MenuItem value={this.state.thursday[i]}>
                          <span className={"selectCName"}>
                            {this.state.thursday[i]}
                          </span>
                        </MenuItem>
                        {this.state.subjects.map((subject) =>
                          this.state.thursday[i] === subject.subject ? null : (
                            <MenuItem key={subject} value={subject.subject}>
                              <span className={"selectCName"}>
                                {subject.subject}
                              </span>
                  ...
                  <div key={i}>
                    {el === "interval" ? (
                      ...
                      <Select
                        ...
                        className={"daySize"}
                      >
                        <MenuItem value={this.state.friday[i]}>
                          <span className={"selectCName"}>
                            {this.state.friday[i]}
                          </span>
                        </MenuItem>
                        {this.state.subjects.map((subject) =>
                          this.state.friday[i] === subject.subject ? null : (
                            <MenuItem key={subject} value={subject.subject}>
                              <span className={"selectCName"}>
                                {subject.subject}
                              </span>
                    ...
                    this.state.checkedSubject === false ? (
                      <div className={"timeslotIcon"}>
                        <IconButton
                          aria-label="delete"
                          style={{ backgroundColor: "transparent" }}
                          onClick={this.removeClickOnDay.bind(this, i)}
                        >
            ...
            <div className={"btnDiv"}>
              <input
                ...
                onClick={this.updateClassTimetable.bind(this)}
              />
              <input
                type={"reset"}
                id={"restBtn"}
