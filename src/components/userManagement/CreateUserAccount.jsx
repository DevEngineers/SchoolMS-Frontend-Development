            ...
            <div id={'largeUserDiv'}>
                <form>
                                ...
                                <Select labelId="demo-simple-select-label" id="demo-simple-select" name={'smBranch'} value={this.state.smBranch}
                                    ...
                                    <MenuItem value={''}><span className={'selectUName'}>Select Branch</span></MenuItem>
                                    {
                                        this.state.sBranch.map(branch =>
                                            <MenuItem key={branch._id} value={branch._id} className={'selectUName'}><span className={'selectUName'}>{branch.branchName}</span></MenuItem>
                                        )
                                    }
                                </Select>
                            </div>
                    ...
                    <div className={'btnEDiv'}>
                        ...
                        <input type={'reset'} id={'restUBtn'} value={'Reset'} onClick={this.restForm.bind(this)}/>
                    </div>
