                ...
                <nav id={'bigDiv'}>
                    ...
                    <ul className={'menu'}>
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="/add-student/_add">Add Student</a></li>
                                <li><a href="/students">View Student</a></li>
                            </ul>
                        </li>
                        <li>
                            {/* First Tier Drop Down */}
                            ...
                            <ul>
                                <li><a href="/add-teacher/_add">Add Teacher</a></li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="/add-payment/_add">Add Fees</a></li>
